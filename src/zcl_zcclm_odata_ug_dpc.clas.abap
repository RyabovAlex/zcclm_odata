...
protected section.
  ...
  methods EXTRACTORSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZCCLM_ODATA_UG_MPC=>TS_EXTRACTOR
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods EXTRACTORSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZCCLM_ODATA_UG_MPC=>TT_EXTRACTOR
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods EXTRACTORSET_UPDATE_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods EXTRACTOR_LOGSET_CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZCCLM_ODATA_UG_MPC=>TS_EXTRACTOR_LOG
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods EXTRACTOR_LOGSET_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods EXTRACTOR_LOGSET_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods EXTRACTOR_LOGSET_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZCCLM_ODATA_UG_MPC=>TT_EXTRACTOR_LOG
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods EXTRACTOR_LOGSET_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
*&* This class has been generated on 12.07.2019 15:56:21 in client 001
*&*
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA extractorset_create_entity TYPE zcl_zcclm_odata_ug_mpc=>ts_extractor.
 ...
 DATA extractor_logset_create_entity TYPE zcl_zcclm_odata_ug_mpc=>ts_extractor_log.
...
*-------------------------------------------------------------------------*
*             EntitySet -  EXTRACTOR_LOGSet
*-------------------------------------------------------------------------*
     WHEN 'EXTRACTOR_LOGSet'.
*     Call the entity set generated method
    extractor_logset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = extractor_logset_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = extractor_logset_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
      when 'EXTRACTOR_LOGSet'.
*     Call the entity set generated method
     extractor_logset_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA extractor_logset_get_entity TYPE zcl_zcclm_odata_ug_mpc=>ts_extractor_log.
 ...
 DATA extractorset_get_entity TYPE zcl_zcclm_odata_ug_mpc=>ts_extractor.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          extractor_logset_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
               IMPORTING er_entity          = extractor_logset_get_entity
                         es_response_context = es_response_context
          ).

        IF extractor_logset_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = extractor_logset_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA extractor_logset_get_entityset TYPE zcl_zcclm_odata_ug_mpc=>tt_extractor_log.
 DATA extractorset_get_entityset TYPE zcl_zcclm_odata_ug_mpc=>tt_extractor.
 DATA lv_entityset_name TYPE string.
...
*-------------------------------------------------------------------------*
   WHEN 'EXTRACTOR_LOGSet'.
*     Call the entity set generated method
      extractor_logset_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = extractor_logset_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = extractor_logset_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA extractor_logset_update_entity TYPE zcl_zcclm_odata_ug_mpc=>ts_extractor_log.
 DATA extractorset_update_entity TYPE zcl_zcclm_odata_ug_mpc=>ts_extractor.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*-------------------------------------------------------------------------*
      WHEN 'EXTRACTOR_LOGSet'.
*     Call the entity set generated method
          extractor_logset_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
               IMPORTING er_entity          = extractor_logset_update_entity
          ).
       IF extractor_logset_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = extractor_logset_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method EXTRACTOR_LOGSET_CREATE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->create_entity( EXPORTING io_data_provider        = io_data_provider
                                                             io_tech_request_context = io_tech_request_context
                                                   IMPORTING es_data                 = er_entity ).
  endmethod.
  ...
  method EXTRACTOR_LOGSET_DELETE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->delete_entity( io_tech_request_context ).
  endmethod.


  method EXTRACTOR_LOGSET_GET_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->get_entity( EXPORTING io_tech_request_context = io_tech_request_context
                                                IMPORTING es_data                 = er_entity ).
  endmethod.


  method EXTRACTOR_LOGSET_GET_ENTITYSET.
    if_sadl_gw_dpc_util~get_dpc( )->get_entityset( EXPORTING io_tech_request_context = io_tech_request_context
                                                   IMPORTING et_data                 = et_entityset
                                                             es_response_context     = es_response_context ).
  endmethod.
  ...
  method EXTRACTOR_LOGSET_UPDATE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->update_entity( EXPORTING io_tech_request_context = io_tech_request_context
                                                             io_data_provider        = io_data_provider
                                                   IMPORTING es_data                 = er_entity ).
  endmethod.
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    DATA(lv_sadl_xml) =
               ...
               | <sadl:dataSource type="DDIC" name="EXTRACTORSet" binding="E2E_EFWK_STATUS" />| &
               | <sadl:dataSource type="CDS" name="EXTRACTOR_LOGSet" binding="ZCCLM_CM_CDS_SYS_EXTR_LOG" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="EXTRACTOR_LOGSet" dataSource="EXTRACTOR_LOGSet" maxEditMode="RO" >| &
               | <sadl:query name="EntitySetDefault" >| &
               | </sadl:query>| &
               | <sadl:attribute name="WLIID" binding="WLIID" isKey="TRUE" />| &
               | <sadl:attribute name="RETURNCODE" binding="RETURNCODE" isKey="FALSE" />| &
               | <sadl:attribute name="MESSAGE" binding="MESSAGE" isKey="FALSE" />| &
               | <sadl:attribute name="RUNTIME" binding="RUNTIME" isKey="FALSE" />| &
               | <sadl:attribute name="RECORDS" binding="RECORDS" isKey="FALSE" />| &
               | <sadl:attribute name="SYSID" binding="SYSID" isKey="TRUE" />| &
               | <sadl:attribute name="ISACTIVE" binding="ISACTIVE" isKey="FALSE" />| &
               | <sadl:attribute name="EXTRACTOR" binding="EXTRACTOR" isKey="FALSE" />| &
               | <sadl:attribute name="NAME" binding="NAME" isKey="FALSE" />| &
               | <sadl:attribute name="DELTA" binding="DELTA" isKey="FALSE" />| &
               | <sadl:attribute name="TIME" binding="TIME" isKey="TRUE" />| &
               | <sadl:attribute name="PHASE" binding="PHASE" isKey="TRUE" />| &
               | <sadl:attribute name="LOGSTATUS" binding="LOGSTATUS" isKey="FALSE" />| &
               |</sadl:structure>| &
               ...
               | <sadl:attribute name="LASTRECORDS" binding="LASTRECORDS" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="T_START_LAST" binding="T_START_LAST" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="T_STOP_LAST" binding="T_STOP_LAST" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="T_START_LAST_SUC" binding="T_START_LAST_SUC" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="T_STOP_LAST_SUC" binding="T_STOP_LAST_SUC" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="SID" binding="SID" isOutput="TRUE" isKey="TRUE" />| &
               | <sadl:attribute name="SYSTEM_TYPE" binding="SYSTEM_TYPE" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="INSTNO" binding="INSTNO" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="CLT" binding="CLT" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="WLI_ID" binding="WLI_ID" isOutput="TRUE" isKey="TRUE" />| &
               | <sadl:attribute name="MAINEXTRACTOR" binding="MAINEXTRACTOR" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="EXTRACTOR" binding="EXTRACTOR" isOutput="TRUE" isKey="TRUE" />| &
               | <sadl:attribute name="EXTRACTORCLASS" binding="EXTRACTORCLASS" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="TIMESTART" binding="TIMESTART" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="TIMESTOP" binding="TIMESTOP" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="COLLECT" binding="COLLECT" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="STATUS" binding="STATUS" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="PRIORITY" binding="PRIORITY" isOutput="TRUE" isKey="FALSE" />| &
               | <sadl:attribute name="RC" binding="RC" isOutput="TRUE" isKey="FALSE" />| &
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = '20190712135614'
               iv_uuid              = 'ZCCLM_ODATA_UG'
               io_query_control     = me
